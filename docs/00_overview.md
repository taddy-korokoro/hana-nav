...
| [20](./20_static-pages.md)        | 静的ページ（terms/privacy）           | -          | W4    |
| [21](./21_deploy-launch.md)       | デプロイ・ローンチ                    | -          | W4    |
| [22a](./22a_rakuten-affiliate.md) | 楽天アフィリエイト導入                | -          | W4 後 |
| [22b](./22b_ui-ux-foundation.md)  | UI/UX 基盤改善（案 X）                | -          | W4 後 |
| [22](./22_instant-navigation.md)  | Instant Navigation 全画面対応         | -          | W4 後 |
