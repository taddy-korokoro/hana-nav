...
- [specs/supabase-auth.md](./specs/supabase-auth.md) — middleware / updateSession の完全コード・DO/DON'T
- [specs/nextjs-conventions.md](./specs/nextjs-conventions.md) — Server Component / Server Action / Route Handler の使い分け
